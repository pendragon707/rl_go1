...
with open('/home/none/rl_go1/scripts/motorstate.csv', 'w') as csv_file: #create new file when import
    csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
    csv_writer.writeheader()

def csv_fill(tick, torque, position, csvfilename = 'motorstate.csv',  WRITE_INTERVAL_MS = 100):
    '''
    ...
    Return:
        add new string in motorstate.csv
    '''
    #curr_tick = tick * 1000 # MUST BE in mils
